  ...
  return (
    <div className="flex flex-col items-start gap-6 lg:gap-8 px-3 lg:px-6 py-4">
      ...
      <div className="flex flex-col gap-4">
        ...
        <p>
          極致計算研究所（Ultracompute）的使命是打造全球首台量子極致電腦，以實現全球首個「人工終極智慧」（Artificial Ultraintelligence，AUI）。我們相信，儘管「人工超級智慧」（ASI）最終或許能透過古典計算實現，但「人工終極智慧」將需要一種全新的計算範式：量子計算。因此，我們除了持續推進量子軟體研究外，目前也正提出開發一種全新計算系統的構想：極致計算機 1號 / Ultracomputer 1 / UC-1，全球首台量子極致電腦；以及 Q-I/O（QIO），專為人工終極智慧設計的新一代量子原生架構。
        </p>
      </div>
